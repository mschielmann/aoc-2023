...
class TestPuzzleSolverShould
{
    ...
    void solvePartOneWithActualData()
    {
        ...
        // THEN
        assertThat(result).isEqualTo(6838L);
    }
    ...
    {
        // GIVEN
        PuzzleSolver puzzleSolver = new PuzzleSolver(TEST_INPUT_3);
    ...
    @Test
    void solvePartTwoWithTestData4()
    {
        // GIVEN
        PuzzleSolver puzzleSolver = new PuzzleSolver(TEST_INPUT_4);
    ...
    @Test
    void solvePartTwoWithTestData5()
    {
        // GIVEN
        PuzzleSolver puzzleSolver = new PuzzleSolver(TEST_INPUT_5);
    ...
    @Test
    void solvePartTwoWithTestData6()
    {
        // GIVEN
        PuzzleSolver puzzleSolver = new PuzzleSolver(TEST_INPUT_6);
    ...
    private static final String TEST_INPUT_6 = """
            FF7FSF7F7F7F7F7F---7
            L|LJ||||||||||||F--J
            FL-7LJLJ||||||LJL-77
            F--JF--7||LJLJ7F7FJ-
