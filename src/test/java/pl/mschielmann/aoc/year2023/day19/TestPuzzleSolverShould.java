...
class TestPuzzleSolverShould
{
    ...
    void solvePartOneWithTestData1()
    {
        ...
        // WHEN
        BigDecimal result = puzzleSolver.solvePartOne();

        // THEN
        assertThat(result).isEqualTo(BigDecimal.valueOf(19114L));
    }
    ...
    void solvePartOneWithActualData()
    {
        ...
        // THEN
        assertThat(result).isEqualTo(BigDecimal.valueOf(476889L));
    }
    ...
    void solvePartTwoWithTestData()
    {
        ...
        // THEN
        assertThat(result).isEqualTo(new BigDecimal("167409079868000"));
    }
    ...
    void solvePartTwoWithActualData()
    {
        ...
        // THEN
        assertThat(result).isEqualTo(new BigDecimal("132380153677887"));
    }
